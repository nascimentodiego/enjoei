...
class EnjoeiTestRunner : AndroidJUnitRunner() {
    override fun onStart() {
        // note on this: if the behavior of the app changes due to the THREAD_POOL_EXECUTOR
        // limit of 128 tasks, we should consider switching to RxIdler
    ...
    override fun newApplication(
        ...
        className: String,
        context: Context
    ): Application = newApplication(EnjoeiTestApplication::class.java, context)
